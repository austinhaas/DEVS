...
** Update DSDEVS implementation.
*** Read the chapter in the book.
*** Use map for messages.
*** Clean up network simulator.
**** Use readable identifiers.
**** Update to support coupled models.
*** Consider creating a version of the dynamic network simulator that does not flatten.
    - Not sure we have a use case.
...
** flashy demo
   - It would be cool to do something 3D, but maybe better to do something that
     can be shown in 100 LOC.
   - Consider a cute educational virus sim.
     - Bunnies turning green and coughing.
     - Expose all parameters.
       - E.g., how much masks help.
