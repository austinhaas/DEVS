...
** Reorganize code
*** DONE Check in latest.
*** DONE Fix cljs issue with ad-hoc-tests w/ counter
*** Rearrange into namespaces.
    - Separate examples from tests.
      - Use the examples in the tests, or use simpler examples.
**** Move the alarm confluence examples to a single example.
     - a somewhat more real-world confluence example
...
** Add more tests.
*** Consider adding some arithmetic circuits
